...
import { FiMail, FiMapPin, FiMonitor, FiPhone } from 'react-icons/fi'
            ...
            <div className="container">
                <div className="app-container">
                    ...
                    <div className="app-container__address">
                        ...
                        <div className="app-container__address-detail">
                            <a href='https://soheils.ir/' className='app-container__address-detail__text'>09331559119</a>
                            <span className='app-container__address-detail__icon'><FiPhone size={25} /></span>
                        </div>
