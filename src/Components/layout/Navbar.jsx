...
const Navbar = () => {
    ...
    const handleActiveNavbar = () => setActive(!active)
        ...
        <nav className='navbars' dir='rtl'>
            <div className="container navbars-items">
                ...
                <div className="navbars-items__left">
                    ...
                    <button className='navbars-items__left-btn btn-order'>پیگیری سفارش</button>
                    <div className="navbars-items__left-mobile" onClick={handleActiveNavbar}><IoMdFingerPrint size={35} /></div>
                </div>
                <div className={active ? "navbars-items__responsive active-nav" : "navbars-items__responsive"} onClick={handleActiveNavbar}>
